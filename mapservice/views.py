...
@login_required
def map(request, name='jkqzdkkjqsdkdkbqds', address='jkqzdkkjqsdkdkbqds'):
    ...
    return render(request, 'mapservice/map.html', {'title': 'Map', 'restaurants' : restaurants, 'posts': posts})
